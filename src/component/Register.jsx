...
const Register = ({ onBack }) => {
  ...
  const duties = ["สายตรวจชุดที่ ๑", "สายตรวจชุดที่ ๒", "สายตรวจชุดที่ ๓", "สายตรวจชุดที่ ๔", "สายตรวจตำบลบ้านเกาะ", "สายตรวจตำบลหมื่นไวย", "สายตรวจตำบลหนองกระทุ่ม", "สายตรวจตำบลหัวทะเล", "สายตรวจตำบลหนองบัวศาลา","สายตรวจตำบลหนองไผ่ ตำบลโพธิ์กลาง","จุดบริการ บขส.","ชุดด่านตรวจ/จุดตรวจ ตามแผนสกัดกั้นยาเสพติด","สายตรวจร้านทอง-ธนาคาร","สิบเวร ควบคุมผู้ค้องหา","ศาลจังหวัด","ศาลแขวง","ศาลแรงงาน","ศาลปกครอง","รปภ.ประจำธนาคาร สถานที่ต่างๆ","ธุรการงาน ป.","ชมส.","อื่นๆ"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://po-leave-backend.onrender.com/api/register', {
        method: 'POST',
        headers: { 
